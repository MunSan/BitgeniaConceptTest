...
urlpatterns = [
    ...
    path('genes/', views.RetrieveGeneListView, name='genes'),
    ...
    path('diseases/', views.RetrieveDiseaseListView, name='diseases'),
    ...
    path('variants/', views.RetrieveVariantListView, name='variants'),
